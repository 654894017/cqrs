 ...
 */
@Slf4j
public abstract class KafkaEventListener2 implements IEventListener {

    private final org.apache.kafka.clients.consumer.KafkaConsumer<String, String> consumer;
    private final String topic;

    public KafkaEventListener2(String topic, String groupId, String bootstrapServers) {
        this.topic = topic;
            ...
            try {
                for (; ; ) {
                    ...
                    for (ConsumerRecord<String, String> record : records) {
                        List<List<Event>> events = map.putIfAbsent(record.partition(), new ArrayList<>());
